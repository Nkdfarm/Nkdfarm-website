  ...
  return (
    <div className="space-y-16">
      ...
      <p className="text-lg leading-relaxed text-muted-foreground">
        At first glance, Philippi — a densely populated township on Cape Town's Cape Flats, better known for its social challenges than its commercial opportunities — may seem like an unconventional choice for a global agricultural R&D hub. The strategic logic, however, is precise: Philippi offers a unique convergence of climate profile, regulatory environment, cost structure, talent access, stress-testing conditions, and expansion space that no single site in Europe or Asia can match at comparable cost.
      </p>
